...
Smalltalk-80 introduced the Model-View-Controller (MVC) architecture for structuring this type of application. MVC separates the _maintenance_ of the domain model (the Model), the _presentation_ of the model (the View), and the _interpretation_ of user input (the Controller).
