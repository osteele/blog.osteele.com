...
These implementations also require a private property for each memoized method.
...
The second variant moves the return and the assignment to the same line. Think
